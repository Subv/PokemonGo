package com.underpressure.pokemongo;
...
public class OverworldActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private final static long LOCATION_REFRESH_TIME = 1000; // In milliseconds
    private final static float LOCATION_REFRESH_DISTANCE = 1.0f; // In meters
    ...
    private final LocationListener locationListener = new LocationListener() {
        ...
        public void onLocationChanged(final Location location) {
            ...
            synchronized (lock) {
                if (selfMarker == null) {
                    selfMarker = map.addMarker(new MarkerOptions().position(position).title("Me"));
                } else {
